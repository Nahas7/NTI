...
void CLCD_vidWriteExtraChar (u8 x,u8 y)
{
	u8 iteration1;

	/*DDRAM-->CGRAM*/
	CLCD_vidSendCommand(64);
	for(iteration1 = 0 ; iteration1 < 40 ; iteration1++)
	{
		CLCD_vidSendData(ExtraChar[iteration1]);
	}
	/*CGRAM-->DDRAM*/
	CLCD_vidGotoXY(x,y);
